...
public class Aplic {
    public static void main(String[] args) {
       ...
       //e FuncionarioComissionado  
        ...
        System.out.println("O Funcionario: " + funcMen.getNome() + "Trabalha no departamento de " + funcMen.getDepartamento().getNome());
        System.out.println("O Funcionario: " + funcCom.getNome() + "Trabalha no departamento de " + funcCom.getDepartamento().getNome());
        ...
        objDep1.listaFuncionarios();

        objDep2.addFuncionario(funcMen);
        objDep2.listaFuncionarios();
        
        //Falta implementar o Projeto
